...
#        'lily',
    ...
    char_contexts_fanfic = {pairing: {} for pairing in pairings}
    for c in chars:
        ...
        with open(os.path.join(fics_fpath, fname)) as f:
            ...
            for pairing in pairings:
                ...
                for para in paras:
                    ...
                    if pairing_present(para, pairing):
                ...
                if fic_pairing_count >= fic_pairing_para_threshold:
                    for context_window in context_windows:
                        char_contexts_fanfic[pairing][c][context_window][fname] = fic_contexts[context_window]
    ...
    for pairing in tqdm(pairings):
        ...
        for c in pairing:
            ...
            for cw in context_windows:
                ...
                vectorizer.fit([' '.join(toks) for toks in char_contexts_fanfic[pairing][c][cw].values()])
